...
class TestTokenReduction(unittest.TestCase):
    ...
    def test_token_reduction_ratio(self, mock_sync, mock_search):
        ...
        mock_search.return_value = [
            MagicMock(path="sections/03_approach.tex", line_start=1, line_end=20, score=0.9, reason="Mock reason", query="Mock query")
        ]
        ...
        self.assertGreaterEqual(reduction_ratio, 3.0, f"Token reduction ratio too low: {reduction_ratio}")
